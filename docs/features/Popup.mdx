...
The position of the popup relative to the clicked item can be configured with the <TypeLink type="OrgChart" member="popupPosition"/> prop.
To adjust the popup visualization, add a custom React component using the <TypeLink type="OrgChart" member="renderPopup"/> prop.
