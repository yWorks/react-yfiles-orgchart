...
<ul className="list-disc ml-4">
    <li>**Overview**: Presents a simplified view of the entire graph along with the current viewport.</li>
    <li>**Controls**: Features a toolbar with buttons to adjust the viewport.</li>
</ul>
