...
Set the <TypeLink type="OrgChart" member="contextMenuItems"/> to populate the context menu with actions.
The organization chart component introduces a default context menu which provides actions to interact with the chart.
...
To adjust the context menu visualization, add a custom React component using the <TypeLink type="OrgChart" member="renderContextMenu"/> prop.
