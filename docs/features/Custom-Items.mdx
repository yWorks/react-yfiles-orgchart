...
This component comes with styling and options suitable for general organizational charts. The items in the `data` array must satisfy the [`OrgChartItem`](../types/orgchartitem) type.
